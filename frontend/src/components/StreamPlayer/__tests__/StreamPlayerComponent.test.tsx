...
describe('StreamPlayerComponent', () => {
  ...
  it('should render player container', () => {
    render(<StreamPlayerComponent source={mockSource} />)
  ...
  it('should accept custom dimensions', () => {
    ...
    const playerDiv = container.firstChild as HTMLDivElement
  ...
  it('should display idle state initially', () => {
    const { container } = render(
      <StreamPlayerComponent source={mockSource} controls={true} />
    )
    // 재생 버튼이 표시되어야 함
    expect(container).toBeTruthy()
  })
  ...
  it('should support WebRTC protocol', () => {
    const webrtcSource: StreamSource = {
      url: 'wss://example.com/whep',
      protocol: 'webrtc',
    }

    const { container } = render(
      <StreamPlayerComponent source={webrtcSource} />
    )
    expect(container).toBeTruthy()
  })
  ...
  it('should support RTSP protocol', () => {
    ...
    const { container } = render(
      <StreamPlayerComponent source={rtspSource} />
    )
    expect(container).toBeTruthy()
  })
  ...
  it('should handle source changes', async () => {
    const { rerender } = render(
      <StreamPlayerComponent source={mockSource} />
    )
    ...
    rerender(<StreamPlayerComponent source={newSource} />)
  ...
  it('should hide controls when disabled', () => {
    const { container } = render(
      <StreamPlayerComponent source={mockSource} controls={false} />
    )
    expect(container).toBeTruthy()
  })
  ...
  it('should handle muted prop', () => {
    const { container } = render(
      <StreamPlayerComponent source={mockSource} muted={true} />
    )
    expect(container).toBeTruthy()
  })
  ...
  it('should handle loop prop', () => {
    const { container } = render(
      <StreamPlayerComponent source={mockSource} loop={true} />
    )
    expect(container).toBeTruthy()
  })
