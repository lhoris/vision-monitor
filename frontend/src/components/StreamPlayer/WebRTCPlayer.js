 ...
 */
class WHEPClient {
    constructor(whepUrl, iceServers = []) {
        ...
        Object.defineProperty(this, "whepUrl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
export class WebRTCPlayer extends StreamPlayer {
    constructor(videoElement, url, webrtcConfig, reconnectConfig) {
        ...
        Object.defineProperty(this, "whepClient", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "webrtcConfig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
