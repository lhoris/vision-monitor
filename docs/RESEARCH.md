...
**적용안**:
- 생산 라인의 다중 카메라 피드를 2x2, 3x3, 4x4 그리드로 표시
...
CREATE TABLE user (
  ...
  department VARCHAR(100) COMMENT 'e.g., 생산 라인 팀',
...
- 예: 생산 라인, 카메라 10개 × 30fps × 60초/분 × 60분/시간 × 24시간 = ~25.9M 프레임/일
...
**검증**: 제조 AI 모니터링 시스템 (Vision Monitor VMS)
