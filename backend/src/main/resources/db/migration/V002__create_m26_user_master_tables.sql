...
CREATE TABLE IF NOT EXISTS TB_M26_CODE_DETAIL (
    ...
    CONSTRAINT FK_M26_CODE_DETAIL_CODE FOREIGN KEY (CODE_ID) REFERENCES TB_M26_CODE (CODE_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS TB_M26_USER_AUTH (
    ...
    CONSTRAINT FK_M26_USER_AUTH_USER FOREIGN KEY (USER_ID) REFERENCES TB_M26_USER (USER_ID),
    CONSTRAINT FK_M26_USER_AUTH_AUTH FOREIGN KEY (AUTH_ID) REFERENCES TB_M26_AUTH (AUTH_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS TB_M26_USER_PERSONAL (
    ...
    CONSTRAINT FK_M26_USER_PERSONAL_USER FOREIGN KEY (USER_ID) REFERENCES TB_M26_USER (USER_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
