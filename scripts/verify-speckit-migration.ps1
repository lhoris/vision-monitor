...
$requiredPaths = @(
    ...
    "specs/001-camera-focus-view/research.md",
    "specs/001-camera-focus-view/data-model.md",
    "specs/001-camera-focus-view/quickstart.md",
    "specs/001-camera-focus-view/tasks.md",
    "specs/001-camera-focus-view/contracts/camera-focus-contract.md",
    "specs/001-camera-focus-view/contracts/focus-route-contract.md",
    "specs/001-camera-focus-view/contracts/ui-state-contract.md"
)
...
if ($featureJson.feature_directory -ne "specs/001-camera-focus-view") {
    throw ".specify/feature.json points to '$($featureJson.feature_directory)' instead of specs/001-camera-focus-view"
}

Assert-TextContains "specs/001-camera-focus-view/spec.md" "## 1\."
Assert-TextContains "specs/001-camera-focus-view/spec.md" "## 2\."
Assert-TextContains "specs/001-camera-focus-view/spec.md" "FR-001"
Assert-TextContains "specs/001-camera-focus-view/spec.md" "active"
Assert-TextContains "specs/001-camera-focus-view/spec.md" "deprecated"
Assert-TextContains "specs/001-camera-focus-view/plan.md" "Mock-First MVP"
Assert-TextContains "specs/001-camera-focus-view/tasks.md" "BMAD"
